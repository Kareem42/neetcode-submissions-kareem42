class Solution {
    public int countStudents(int[] students, int[] sandwiches) {
        ...
        // Set the res to n 
        int res = n;
        // create an count array and set it to hold 2 entries, one for students and one sandwiches
        int [] cnt = new int [2];

        // Loop through the length of students, which is n and increment the count of the students by 1
        for (int i = 0; i < n; i++){
            cnt[students[i]]++;
        }
